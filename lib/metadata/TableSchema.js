...
class TableSchema {
  ...
  parseAboutUrl() {
    ...
    return (row) => {
      return this.factory.namedNode(new URL(this.baseIRI, aboutUrlTemplate.fill(row)).toString())
    }
  }
  ...
  subject(column, row) {
    ...
    return this.factory.namedNode(new URL(this.baseIRI, column.aboutUrl.fill(row)).toString())
  }
